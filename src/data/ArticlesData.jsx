...
export const articlesData = [
  {
    ...
    content: [
      { type: 'paragraph', text: 'Rodzice często zastanawiają się, kiedy jest odpowiedni moment, by udać się z dzieckiem do logopedy. Warto pamiętać, że im wcześniej zareagujemy na trudności w rozwoju mowy, tym skuteczniejsza może być terapia. Do logopedy warto zgłosić się, jeśli:' },
      {
        ...
        ordered: false,
        items: [
          'dziecko nie gaworzy lub nie wypowiada pierwszych słów w oczekiwanym czasie,',
          'ma trudności z rozumieniem mowy,',
          'mówi niezrozumiale dla otoczenia po 3. roku życia,',
          'występują problemy z artykulacją głosek (np. zamienia „r” na „l”),',
          'dziecko jąka się lub mówi zbyt szybko.'
        ]
      },
      { type: 'paragraph', text: 'Wizyty kontrolne u logopedy zalecane są również profilaktycznie – nawet jeśli nie ma wyraźnych problemów, ale rodzic ma jakiekolwiek wątpliwości.' }
    ]
  },
  {
    ...
    content: [
      { type: 'paragraph', text: 'Rozwój mowy to proces, który zaczyna się już w życiu płodowym, kiedy dziecko słyszy głosy mamy i dźwięki z otoczenia. Po narodzinach obserwujemy:' },
      {
        ...
        ordered: false,
        items: [
          '0–6 mies. – głużenie i reakcja na dźwięki,',
          '6–12 mies. – gaworzenie, pierwsze sylaby,',
          '1 rok – pierwsze słowa: „mama”, „tata”,',
          '2 lata – łączenie wyrazów w proste zdania,',
          '3–4 lata – opowiadanie, budowanie dłuższych wypowiedzi.'
        ]
      },
      { type: 'paragraph', text: 'Każde dziecko rozwija się w swoim tempie, jednak duże opóźnienia, brak kontaktu wzrokowego czy brak prób komunikacji powinny być skonsultowane ze specjalistą.' }
    ]
  },
  {
    ...
    content: [
      { type: 'paragraph', text: 'Logopedia online to nowoczesna forma terapii logopedycznej prowadzona zdalnie, najczęściej za pośrednictwem komputera lub tabletu z dostępem do internetu. To idealne rozwiązanie dla:' },
      {
        ...
        items: [
          ...
          'dzieci i dorosłych z ograniczoną mobilnością,',
          'rodzin poszukujących elastycznych godzin terapii.'
        ]
      },
      { type: 'paragraph', text: 'Zajęcia prowadzone online są równie skuteczne jak spotkania stacjonarne – pod warunkiem odpowiedniego zaangażowania i wsparcia ze strony rodzica. Logopeda przygotowuje indywidualne ćwiczenia, korzysta z interaktywnych materiałów i prowadzi terapię „na żywo” poprzez kamerę i mikrofon.' }
    ]
  },
  {
    ...
    content: [
      { type: 'paragraph', text: 'Tak! Logopeda pracuje również z niemowlętami. Wizyta może być wskazana już w pierwszych tygodniach życia dziecka, zwłaszcza gdy:' },
      {
        ...
        ordered: false,
        items: [
          'występują trudności z ssaniem lub karmieniem,',
          'niemowlę nie domyka ust, ma napięte policzki, nie układa języka prawidłowo,',
          'rodzic zauważa asymetrię w pracy języka, warg czy szczęki,',
          'dziecko urodziło się przedwcześnie lub z obciążonym wywiadem okołoporodowym.'
        ]
      },
      { type: 'paragraph', text: 'Logopeda niemowlęcy (neurologopeda) pracuje z dzieckiem bardzo delikatnie, wspiera rozwój funkcji orofacjalnych i daje rodzicom wskazówki do codziennej stymulacji rozwoju mowy już od pierwszych miesięcy.' }
    ]
  },
  {
    ...
    content: [
      ...
      { type: 'paragraph', text: 'Dziecko zazwyczaj powinno opanować głoskę „r” do 6. roku życia. Jeśli po tym czasie nadal mówi „lowel” zamiast „rower”, warto rozpocząć terapię logopedyczną. Terapeuta:' },
      {
        type: 'list',
        ordered: false,
        items: [
          'oceni budowę i sprawność narządów mowy,',
          'przeprowadzi ćwiczenia usprawniające język,',
          'nauczy dziecko etapami prawidłowej wymowy głoski „r”.'
        ]
      },
      { type: 'paragraph', text: 'Pamiętajmy – im wcześniej rozpoczniemy terapię, tym większa szansa na szybkie i trwałe efekty.' }
    ]
  },
  {
    ...
    content: [
      { type: 'paragraph', text: 'Logopedia nie jest zarezerwowana wyłącznie dla dzieci. Coraz więcej dorosłych korzysta z terapii logopedycznej z różnych powodów:' },
      {
        ...
        ordered: false,
        items: [
          'jąkanie, szybka lub niewyraźna mowa,',
          'zaburzenia głosu (chrypka, bezgłos),',
          'problemy z artykulacją (np. po operacjach, wypadkach),',
          'afazja po udarze lub urazie mózgu,',
          'chęć poprawy dykcji, np. u nauczycieli, aktorów, lektorów.'
        ]
      },
      { type: 'paragraph', text: 'Terapia u dorosłych często łączy ćwiczenia oddechowe, artykulacyjne, fonacyjne i elementy treningu emisji głosu. Dzięki regularnej pracy i wsparciu logopedy można znacząco poprawić komfort codziennej komunikacji.' }
    ]
  }
];
